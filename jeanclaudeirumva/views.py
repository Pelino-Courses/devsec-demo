...
from .forms import (
    RegistrationForm, LoginForm, PasswordChangeForm,
...
def upload_avatar_view(request):
    ...
    return render(request, 'jeanclaudeirumva/upload_avatar.html', {'form': form})
...
def upload_document_view(request):
    ...
    return render(request, 'jeanclaudeirumva/upload_document.html', {'form': form})