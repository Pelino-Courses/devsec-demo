...
class CSRFTestCase(TestCase):
    ...
    def test_ajax_update_requires_csrf(self):
        self.client.login(username='testuser', password='StrongPass123!')
        response = self.client.post(
            reverse('jeanclaudeirumva:update_profile_ajax'),
            {'email': 'new@example.com'},
        )
        self.assertEqual(response.status_code, 403)

    def test_ajax_update_works_with_csrf(self):
        self.safe_client.login(username='testuser', password='StrongPass123!')
