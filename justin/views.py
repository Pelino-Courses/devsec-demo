...
def get_safe_redirect_url(request, default='profile'):
...
def register_view(request):
    ...
    return render(
        request,
        'justin/register.html',
        {'form': form, 'next_url': get_safe_redirect_url(request, default='')},
    )
...
def logout_view(request):
    ...
    return redirect(get_safe_redirect_url(request, default='login'))
