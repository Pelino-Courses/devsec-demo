...
from .auth_views import AuditPasswordResetView, AuditPasswordResetConfirmView
from .views import (
...
urlpatterns = [
    path('password-reset/', AuditPasswordResetView.as_view(
    ...
    path('reset/<uidb64>/<token>/', AuditPasswordResetConfirmView.as_view(
